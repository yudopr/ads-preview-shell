    ...
    if(indev){
        if(resolve_bg){
            resolve_bg.play().catch(e=>{
                setTimeout(e=>{
                    console.log("called to endframe")
                    hide('preloader');
                    //show('resolve_bg', 0.3);
                    resolveTL.pause("end");
                }, 100)
...
HTMLElement.prototype.replayColor = function(e){
    t = document.createElementNS("http://www.w3.org/2000/svg", "svg"), t.id = "replay_icon", t.setAttribute('width', '100%'), t.setAttribute('height', '100%'), t.setAttribute('viewBox', '0 0 60 60'), t.innerHTML = '<path d="M10.779,7.204c5.171,-4.49 11.886,-7.204 19.221,-7.204c16.325,0 29.579,13.443 29.579,30c0,16.557 -13.254,30 -29.579,30c-16.325,0 -29.579,-13.443 -29.579,-30l10.292,0c0,10.796 8.642,19.561 19.287,19.561c10.645,0 19.287,-8.765 19.287,-19.561c0,-10.796 -8.642,-19.561 -19.287,-19.561c-4.494,0 -8.631,1.562 -11.911,4.18l6.172,6.259l-20.585,0l0,-20.878l7.103,7.204Z" id="replay_arrow" class="button" style="fill:' + e + '"/>', this.appendChild(t);
    return this;
}
HTMLElement.prototype.soundButton = function(e){
    t = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
    t.id = "unmute_icon",
    t.setAttribute('width', '100%'),
    t.setAttribute('height', '100%'),
    t.setAttribute('viewBox', '0 0 60 60'),
    t.innerHTML =
    '<path class="fill_color" style="fill:'+e+'" d="M21.617,24.088l9.547,-7.575c0.151,-0.119 0.356,-0.142 0.529,-0.058c0.172,0.083 0.282,0.258 0.282,0.45l0,25.353c0,0.192 -0.11,0.367 -0.282,0.451c-0.173,0.083 -0.378,0.06 -0.529,-0.059l-9.547,-7.575l-6.367,0c-0.276,0 -0.5,-0.224 -0.5,-0.5l0,-9.987c0,-0.276 0.224,-0.5 0.5,-0.5l6.367,0Z" />'+
    '<path id="auline1" class="fill_color" style="fill:'+e+'" d="M34.615,24.749c0,0 2.198,1.946 2.198,4.833c0,2.908 -2.219,4.981 -2.219,4.981c-0.403,0.378 -0.423,1.011 -0.045,1.413c0.377,0.403 1.011,0.423 1.413,0.046c0,0 2.851,-2.684 2.851,-6.44c0,-3.779 -2.871,-6.329 -2.871,-6.329c-0.413,-0.366 -1.046,-0.328 -1.412,0.085c-0.366,0.413 -0.328,1.045 0.085,1.411Z" />'+
